...
#define SYSDAL_INTSCH_AR_RELEASE_MINOR_VERSION_C        3
#define SYSDAL_INTSCH_AR_RELEASE_REVISION_VERSION_C     1

#define SYSDAL_INTSCH_SW_MAJOR_VERSION_C                0
#define SYSDAL_INTSCH_SW_MINOR_VERSION_C                8
