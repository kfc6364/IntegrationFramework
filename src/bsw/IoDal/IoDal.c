...
#define IODAL_AR_RELEASE_MINOR_VERSION_C        3
#define IODAL_AR_RELEASE_REVISION_VERSION_C     1

#define IODAL_SW_MAJOR_VERSION_C                0
#define IODAL_SW_MINOR_VERSION_C                8
