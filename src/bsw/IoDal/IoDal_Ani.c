...
#define IODAL_AR_RELEASE_MINOR_VERSION_ANI_C        3

#define IODAL_AR_RELEASE_REVISION_VERSION_ANI_C     1

#define IODAL_SW_MAJOR_VERSION_ANI_C                0
#define IODAL_SW_MINOR_VERSION_ANI_C                8
