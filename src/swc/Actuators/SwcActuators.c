...
#define SWCACTUATORS_SW_MAJOR_VERSION_C                   0
#define SWCACTUATORS_SW_MINOR_VERSION_C                   8
...
void SwcActuators_MainRunnable()
{
    ...
    SwcRte_AppLightingActuatorValueType  LightingOutputValue;
#endif
#if (SWCRTE_MOTORCTRL_APP_ENABLED == SWCRTE_STD_ON)    
    SwcRte_AppMotorCtrlActuatorValueType  MotorCtrlOutputValue;
#endif    
        ...
        switch (AppType)
        {
            ...
            case SWCRTE_LIGHTING:
            {
                ...
                for (AppChannelId = 0; AppChannelId < SwcActuators_ConfigPtr[RteAppInstance].u8NoOutputChannel; AppChannelId++)
                {
                    ...
                    if((SWCRTE_CHANNEL_SHORT2GND == LightingOutputValue.aChannelState[AppChannelId]) ||
                      (SWCRTE_CHANNEL_OPEN_LOAD == LightingOutputValue.aChannelState[AppChannelId]))
                    {
                        OutputValue = 0U;
                    }
                    else
