...
#define IODAL_TYPES_AR_RELEASE_MINOR_VERSION            3
#define IODAL_TYPES_AR_RELEASE_REVISION_VERSION         1

#define IODAL_TYPES_SW_MAJOR_VERSION                    0
#define IODAL_TYPES_SW_MINOR_VERSION                    8
